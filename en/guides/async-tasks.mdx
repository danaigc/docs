...
If you don't want to poll, include `webhook_url` when you create the task. Egg API will POST to your URL when the task completes or fails. You can get a test URL from `https://webhook.site/`.
