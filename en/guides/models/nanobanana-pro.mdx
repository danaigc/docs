...
- **Resolution**: 16:9 or 9:16 (256-2048)
...
<ParamField body="width" type="integer">
  Image width in pixels (256-2048). Must be 16:9 or 9:16 with height.
</ParamField>

<ParamField body="height" type="integer">
  Image height in pixels (256-2048). Must be 16:9 or 9:16 with width.
</ParamField>
